...
const userName = 'darkhackersl';
const token = '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';
const repoName = 'Thenu-MD-DATABASE';
...
config.FOOTER = '©Thenu  - ＭＤ'
config.LOGO = `https://i.ibb.co/hy0CnW9/Thenu-md.png` 
config.ANTI_BAD = []
